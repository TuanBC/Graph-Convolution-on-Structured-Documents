...
class ObjectTree:	
    ...
    def connect(self, plot=False, export_df=False):
        ...
        # print(df.iloc[nearest_dest_ids_vert]['Object'])
        # print(df.loc[nearest_dest_ids_vert, 'Object'])

        # df['below_object'] = df.loc[nearest_dest_ids_vert, 'Object'].values
        df['below_object'] = df.iloc[nearest_dest_ids_vert]['Object'].values
        ...
        df['side_object'] = df.iloc[nearest_dest_ids_hori]['Object'].values
...
if __name__ == "__main__":
    ...
    img = cv2.imread('./data/deskew.jpg', 0)
